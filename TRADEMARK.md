...
- **코드는 GPL-3.0-or-later 입니다.** 쓰고, 고치고, 다시 포크해도 됩니다. 고친 것을 배포할 때는 소스를 같은 조건으로 공개해야 합니다. 원본에서 물려받은 부분은 MIT 로 받았고 그 고지를 `LICENSE.upstream-MIT` 에 두었습니다
- **"career-ops"는 원저자의 상표입니다.** 이 저장소는 그 이름을 제품 이름으로 쓰지 않습니다
- **"cicerone"는 이 포크의 이름입니다.** 상표 등록은 하지 않았습니다
...
"cicerone"에 상표 등록을 하지 않았고 할 계획도 없습니다. 이름을 가져다 쓰는 것을 막지 않습니다.
