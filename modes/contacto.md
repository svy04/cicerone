...
## 한국에서 이 모드를 쓸 때 (먼저 읽습니다)

**국내 기업 지원에서 채용 담당자에게 먼저 연락하는 것이 통한다는 근거를 찾지 못했습니다.** 미국에서는 흔한 방식이고 원본이 그 전제로 만들어졌지만, 한국 시장에서 효과를 측정한 자료는 확인하지 못했습니다. 권하지도 말리지도 않고, 근거가 없다는 사실을 후보자에게 알립니다.

지원하는 곳에 따라 갈립니다.

| 어디에 지원하나 | 접촉이 자연스러운가 | 경로 |
|---|---|---|
| 외국계·해외 기업 | 링크드인 연결 요청이 관행입니다 | 아래 링크드인 절 그대로 |
| 국내 스타트업·테크 | 채용 페이지 문의 창구나 원티드 리퍼럴이 있으면 그쪽이 자연스럽습니다 | 공고에 적힌 창구 우선 |
| 국내 대기업 공채 | 접촉 경로가 사실상 없습니다. 지원서가 유일한 창구입니다 | 이 모드를 쓰지 않습니다 |
| 경력 스카우트 제안을 받은 경우 | 이미 상대가 먼저 연락한 상태입니다 | 그 대화에서 이어 갑니다 |

**리퍼럴이 있으면 그것이 먼저입니다.** 아는 사람이 그 회사에 있으면 콜드 메시지보다 훨씬 확실합니다. 후보자에게 먼저 물어봅니다.

**하지 않는 것**: 개인 연락처를 수집하거나 추측하지 않습니다. 공개된 창구만 씁니다.
