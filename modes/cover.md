...
Read `modes/_writing.md` — 문체 가드레일입니다. 후보자의 글을 검토할 때, 그리고 구조를 제안할 때 이 기준을 씁니다. `voice-dna.md` 가 있으면 함께 읽습니다.
...
원본 영어판의 커버레터 계약(350-420 words 한 장)은 한국 자기소개서에 맞지 않습니다. 한국은 회사가 문항과 글자 수를 정해 주기 때문입니다. 대신 아래를 지킵니다.

- **글자 수**: 회사가 정한 제한을 따릅니다. 대기업 문항은 보통 600자에서 1500자 사이입니다. 공백을 포함해 세는 것이 관행이고, 지원서 화면이 다르게 세면 그것을 따릅니다. 제한의 80%를 밑돌면 성의가 없어 보이고, 넘으면 잘립니다
- **문단 형식**: 문항 하나에 문단 두세 개. 첫 문장에 결론을 놓습니다. 개조식 목록은 쓰지 않습니다 — 한국 자기소개서는 서술형입니다
- **어조 일관성**: 한 자기소개서 안에서 문체를 섞지 않습니다. 문항별로 존댓말과 평서체가 오가면 읽는 사람이 걸립니다
- **자가 점검**: 내보내기 전에 아래를 확인합니다
  ...
  - 글자 수가 제한 안에 들어오는가
- **초안만 만듭니다**: 도구가 지원서를 제출하지 않습니다. 사람이 읽고 고치고 직접 냅니다
