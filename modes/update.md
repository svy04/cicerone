...
```bash
git fetch https://github.com/svy04/cicerone.git main || {
...
> **Changelog:** not available for v{remote}. The release notes are at https://github.com/svy04/cicerone/releases
