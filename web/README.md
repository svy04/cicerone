...
An **experimental, opt-in web UI** for cicerone. It is a local-first *view* over
...
Open http://localhost:3000. The app reads the cicerone checkout it lives in
...
a different cicerone directory (useful for testing against sample data).
