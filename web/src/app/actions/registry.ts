...
const CANON_STATUS = ["Evaluated", "Applied", "Responded", "Written", "Interview", "Offer", "Hired", "Rejected", "Discarded", "SKIP"];

const TAB_VALUES = [
  "INBOX", "ALL", "EVALUATED", "APPLIED", "RESPONDED", "WRITTEN", "INTERVIEW", "OFFER", "HIRED", "REJECTED", "DISCARDED", "SKIP",
] as const;
